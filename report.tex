...
\date{April 2023}
\titlepic{
    \includegraphics[height=100pt]{fizz_logo.jpg}
    \hspace*{10pt}
    \includegraphics[height=100pt]{ubc_logo.png}
    }
...
\section{Navigation}
    ...
    \subsection{Navigation Algorithms}
        ...
        \subsubsection{Grass Navigation}
            ...
            \begin{figure}
                \begin{center}
                    \includegraphics[width=0.7\linewidth]{grass-photos.png}
                \end{center}
